...
package lava.bluepay.com.lavaapp.view.progressbar;
...
import lava.bluepay.com.lavaapp.view.progressbar.internal.ThemeUtils;
    ...
    public void setShowTrack(boolean showTrack) {
        if (mTrackDrawable.getShowTrack() != showTrack) {
            ...
            if (showTrack) {
                ...
                mSecondaryProgressDrawable.setAlpha(2 * mSecondaryAlpha);
            }
        }
    }
